...
public class NormalTitleBar extends RelativeLayout {
    ...
    private ImageView ivRight,ivRight1,ivRight2;
    ...
    public NormalTitleBar(Context context, AttributeSet attrs) {
        ...
        ivRight1 = (ImageView) findViewById(R.id.image_right1);
        ivRight2 = (ImageView) findViewById(R.id.image_right2);
    ...
    public void setRightImagSrc2(int id) {
    ...
    public void setOnRightImagListener2(OnClickListener listener) {
